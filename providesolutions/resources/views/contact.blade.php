    ...
    <div class="container">
        ...
        <div class="contact-title">
            ...
            <div class="buttons" data-aos="fade-up">
                <a href="tel:+994555056614" class="button-grey"><img src='{{ asset('assets/images/phone-1.png') }}'> +994 55 505 66 14</a>
                <a href="tel:+994555056614" class="button-grey"><img src='{{ asset('assets/images/phone-1.png') }}'> +994 55 505 66 14</a>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="contact-boxes">
                <div class="contact-box" data-aos="fade-up">
                    ...
                    <p class="box-subtitle">Bu xidmət partnyor şirkətin satınalma sifarişlərinin izlənilməsi və yoxlanılmasından ibarətdir.</p>
                </div>
                <div class="contact-box" data-aos="fade-up">
                    <div class="box-icon"><img src='{{ asset('assets/images/blue.png') }}'/></div>
                    <p class="box-title">Logistika və Gömrük</p>
                    <p class="box-subtitle">Logistika/Gömrük xidmətinə xarici ölkədən idxal olunacaq yüklərin daşınması və gömrüklənmə prosesi daxildir.</p>
                </div>
                <div class="contact-box" data-aos="fade-up">
                    <div class="box-icon"><img src='{{ asset('assets/images/blue.png') }}'/></div>
                ...
                <div class="contact-box" data-aos="fade-up">
                    ...
                    <p class="box-subtitle">Provide Solutions şirkəti partnyorlara bu xidməti satışlarının optimallaşdırılması məqsədini güdərək təqdim edir.</p>
                </div>
            </div>
        </div>
    </div>
