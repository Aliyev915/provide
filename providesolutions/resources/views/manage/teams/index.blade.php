    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('create-team') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($teams as $team)
                                <tr>
                                    ...
                                    <td>{{ $team->langs->firstWhere('lang',app()->getLocale())->fullname }}</td>
                                    <td>{{ $team->langs->firstWhere('lang',app()->getLocale())->profession }}</td>
