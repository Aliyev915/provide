                    ...
                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="translatable-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="description_lang"
                                    value='{"az":"{{ $blog->langs->firstWhere('lang', 'az')->description }}","ru":"{{ $blog->langs->firstWhere('lang', 'ru')->description }}","en":"{{ $blog->langs->firstWhere('lang', 'en')->description }}"}'>
                                <textarea name="description" class="form-control"
                                    rows="5">{{ $blog->langs->firstWhere('lang', app()->getLocale())->description }}</textarea>
                                @error('description')
                                    <span class="text-danger mt-2 d-inline-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="upload-box">
                                <div class="image-box">
                                    <img src="{{ asset('uploads/blogs/' . $blog->image) }}" width="200" alt="">
